...
const {name, age, mood, hobby, premium} = user
console.log(name, age, mood, hobby, premium);
...
const {Ostap, Mary, Max, Zack} = people
console.log(Ostap, Mary, Max, Zack);
...
const {type, price, category} = product
console.log(type, price, category);
